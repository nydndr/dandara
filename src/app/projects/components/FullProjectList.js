          ...
          <>
            {allProjects.map((project, projectIndex) => (
              <article key={projectIndex} className="">
                <div className="flex-col items-center justify-between space-y-4 rounded-md border-1 border-gray-700/20 py-6">
                  <Image
                    src={"/work/pos.png"}
                    width={2929}
                    height={3905}
                ...
                <ul className="my-1 gap-4 space-y-2 md:flex md:space-y-0">
                  {project.links ? (
                ...
                {project.posts.length > 0 ? (
                  <div className="my-4 ml-6 border-l-2 border-(--foreground)/20 pl-4">
                    <p className="font-mono text-sm font-bold text-(--foreground)/40 uppercase">
                      I also wrote about it:
                    </p>
                    <ul className="flex list-disc space-y-2 p-1 px-6">
                      {project.posts.map((post, postIndex) => (
                        <li className="flex" key={postIndex}>
                          <Link
                          ...
                          {post.language == "portuguese" ? (
                            <span className="flex h-fit w-fit items-end gap-1 space-x-4 rounded-md px-1 py-0.5 font-mono text-sm font-medium text-(--foreground)/40 uppercase">
                              PT
