        ...
        <div className="space-y-2">
          <h2 className="text-xl font-medium text-gray-700 md:text-3xl md:leading-10">
            ...
            <span className="textmarker-effect-auto">
              design, craft, product
            </span>{" "}
            and whatever else I please.
          </h2>
          <div className="my-12 flex h-fit items-center gap-2 rounded-md border-1 border-gray-700/20 p-4">
            ...
            <h3 className="text-lg font-medium text-gray-700/80 md:leading-9">
              Eu também escrevo mensalmente na{" "}
              <Link
                href="https://nydndr.substack.com/?utm_campaign=profile_chips"
